		...
		<div class="row">
			<div class="col">
				...
				<div class="form-group">
					...
					<div class="row">
						<div class="col-md-4">
							<input type="text" class="form-control border-dark" id="tmt_cpns" name="tmt_cpns_hr" placeholder="DD"  value="<?php echo substr($hasil->tmt_cpns,8,2)?>">
						</div>
						<div class="col-md-4">
							<input type="text" class="form-control border-dark" id="tmt_cpns" name="tmt_cpns_bln" placeholder="BB"  value="<?php echo substr($hasil->tmt_cpns,5,2)?>"> 
						</div>
						<div class="col-md-4">
							<input type="text" class="form-control border-dark" id="tmt_cpns" name="tmt_cpns_thn" placeholder="TTTT"  value="<?php echo substr($hasil->tmt_cpns,0,4)?>">
						</div>
					</div>		
				</div>
