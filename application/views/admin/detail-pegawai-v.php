					...
					<form action="<?php echo base_url('index.php/admin/pegawai/update_foto_pegawai') ?>" method="post" enctype="multipart/form-data">
						<div class="row user-stats text-center">
							...
							<div class="col">
								...
								<button type="submit" name="submit" value="submit" class="btn btn-success btn-sm"><i class="icon-check"></i> Simpan</button>
							</div>
							<div class="col">
								<div class="title">Cetak Data Pengawai</div>
								<a href="<?php echo base_url('index.php/admin/pegawai/cetak_data_pegawai/'.$hasil->id_pegawai) ?>" target="_blank" class="btn btn-info btn-sm"><i class="icon-printer"></i> Cetak Data Pegawai</a>
							</div>
						</div>
					</form>
				</div>
